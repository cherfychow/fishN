...
tij_1 <- ggplot(data = data_ruv %>% filter(site_ID == 'hale_kaku')) +
  geom_density(aes(x = staytime, group = Taxon, color = Taxon), size = 0.5) +
  theme_classic(base_size = 13) + labs(x = "Staying time (s)", title = "Hale Kaku") +
  scale_color_cherulean(palette = 'gomphosus', discrete = T, alpha = 0.5) + guides(color = 'none')

tij_2 <- ggplot(data = data_ruv %>% filter(site_ID == 'hale_kinalea')) +
  geom_density(aes(x = staytime, group = Taxon, color = Taxon), size = 0.5) +
  theme_classic(base_size = 13) + labs(x = "Staying time (s)", title = "Hale Kinalea") +
  scale_color_cherulean(palette = 'gomphosus', discrete = T, alpha = 0.5) + guides(color = 'none')
...
Y1 <- ggplot(data = sp_decs %>% filter(site_ID == 'hale_kaku')) +
  geom_density(aes(x = occurrences, group = Taxon, color = Taxon), size = 0.5) +
  theme_classic(base_size = 13) + labs(x = "Number of occurrences", title = "Hale Kaku") +
  scale_color_cherulean(palette = 'gomphosus', discrete = T, alpha = 0.5) + guides(color = 'none')

Y2 <- ggplot(data = sp_decs %>% filter(site_ID == 'hale_kinalea')) +
  geom_density(aes(x = occurrences, group = Taxon, color = Taxon), size = 0.5) +
  theme_classic(base_size = 13) + labs(x = "Number of occurrences", title = "Hale Kinalea") +
  scale_color_cherulean(palette = 'gomphosus', discrete = T, alpha = 0.5) + guides(color = 'none')
...
ggplot(data = dt_SAD_site) +
  ...
  theme_classic(base_size = 13) + 
  labs(x = "Occurrence classes", y = "Relative number of species",
       title = "SADs by site")
